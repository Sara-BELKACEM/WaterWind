...
function EmptyCropState({ onAdd }) {
  return (
    <Card className="rounded-[24px] border border-dashed border-slate-300 bg-slate-50/70 px-6 py-10 text-center dark:border-slate-700 dark:bg-slate-900/60">
      ...
      <h3 className="mt-4 text-xl font-semibold text-slate-900 dark:text-white">No crops found.</h3>
      <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Create a new crop profile to start recommendations.</p>
